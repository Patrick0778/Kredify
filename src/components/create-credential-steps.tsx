      ...
      <TabsList className="grid w-full grid-cols-4">
        {steps.map((step) => (
          <TabsTrigger 
            key={step.id}
            value={`step-${step.id}`}
            className={currentStep >= step.id ? "data-[state=active]:bg-primary data-[state=active]:text-primary-foreground" : ""}
        ...
        {currentStep === 1 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload the document you want to mint as a credential</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {!uploadedFile ? (
                  <>
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-sm text-muted-foreground">Supports PDF, PNG, JPG (max 10MB)</p>
                    </div>
        ...
        {currentStep === 2 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add important information about your credential</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-6">
                <div className="grid gap-3">
                  <Label htmlFor="title">Credential Title</Label>
                  <Input id="title" placeholder="E.g. Bachelor of Science in Computer Science" />
                </div>
                ...
                <div className="grid gap-3">
                  ...
                  <Textarea id="description" placeholder="Provide details about this credential..." />
                </div>
              </div>
            </CardContent>
        ...
        {currentStep === 3 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review your credential before minting</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="grid gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm">
                      This credential certifies that the holder has completed all requirements 
                      for the Bachelor of Science in Computer Science program at ABC University.
                    </div>
                  </div>

                  <div className="pt-2">
                    <div className="text-sm font-medium text-muted-foreground">Document Hash</div>
        ...
        {currentStep === 4 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Complete the credential minting process</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                ...
                {transactionSent ? (
                  <div className="flex flex-col items-center justify-center p-6 text-center">
                    ...
                    <h3 className="text-lg font-semibold mb-1">Transaction Submitted</h3>
                    <p className="text-sm text-muted-foreground mb-4">
                    ...
                    <div className="font-mono text-xs bg-muted p-2 rounded w-full overflow-hidden text-ellipsis text-center">
                      Tx: 8f4d2b3c1e6a9f7b2c8d3e4f5a6b7c8d9e0f1a2b3c4d5e6f7a8b9c0d1e
                    </div>
                  </div>
                ) : (
                  <div className="flex flex-col items-center justify-center p-6 text-center">
                    <Wallet className="h-12 w-12 text-primary mb-4" />
                    <h3 className="text-lg font-semibold mb-4">Ready to mint credential</h3>
                    <p className="text-sm text-muted-foreground mb-4">
